...
choice2 = st.sidebar.selectbox('选择行业', st.session_state.stock_xx["二级行业"].unique())
cw_xx_hy=cw_xx[cw_xx["二级行业"]==choice2]
st.subheader(choice2)

stock_list=cw_xx_hy["股票简称"].unique()
